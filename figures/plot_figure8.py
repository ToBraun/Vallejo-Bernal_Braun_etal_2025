...
'''
This script produces Fig. 8 of Vallejo-Bernal & Braun et al., (2025)
...
# Folders and files
input_folder = root_folder + 'data/figure08/'
figure_file = root_folder + 'manuscript/PIKART_Figure8.png'
